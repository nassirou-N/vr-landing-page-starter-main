  ...
  return <section className='min-h-[400px] mb-16 lg:mb-4 '>
    <div className='container mx-auto h-full'>
      <div className='h-full bg-explore bg-no-repeat bg-cover p-14 flex flex-col items-start justify-center'>
        ...
        <p className='max-w-xs mb-12'>Lorem ipsum dolor sit amet consectetur adipisicing elit. quam quo quia maxime adipisci tempora distinctio temporibus sequi difnissimos Iusto, facilis.</p>
        {/**form text */}
