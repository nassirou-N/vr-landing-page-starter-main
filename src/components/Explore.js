  ...
  return <section className='min-h-[400px] mb-16 lg:mb-4 '>
    <div className='container mx-auto h-full'>
      <div className='h-full bg-explore bg-no-repeat bg-cover p-14 flex flex-col items-start justify-center'>
        ...
        <p className='max-w-xs mb-12'  data-aos='fade-right' data-aos-offset='1100'>Lorem ipsum dolor sit amet consectetur adipisicing elit. quam quo quia maxime adipisci tempora distinctio temporibus sequi difnissimos Iusto, facilis.</p>
        {/**form text */}
        <form className='flex flex-col w-full space-y-4 gap-x-4 lg:flex-row lg:space-y-0'  data-aos='fade-up' data-aos-offset='1200'>
