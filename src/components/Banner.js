    ...
    <div className="container mx-auto">
      <div className='flex items-center flex-col lg:flex-row'>
        ...
        <div>
          ...
          <div className='flex items-center justify-around space-x-4 max-w-[320px] mx-auto mb-12 lg:space-x-8 lg:mx-0 lg:justify-start lg:max-w-none' data-aos='fade-down' data-aos-delay="700">
